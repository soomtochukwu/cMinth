    ...
    <div className="mt-4 p-4 bg-gray-900/60 backdrop-blur-md rounded-lg border border-gray-800/50 shadow-lg">
      <div className="flex flex-wrap gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Popover open={showBackgroundOptions} onOpenChange={setShowBackgroundOptions}>
            ...
            <PopoverContent className="w-80 p-4 bg-gray-900/90 backdrop-blur-md border border-gray-800/80 shadow-xl shadow-cyan-500/10 rounded-lg">
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  <div>
                    <h5 className="text-xs font-medium text-gray-400 mb-2">Solid Colors</h5>
                  ...
                  <div>
                    <h5 className="text-xs font-medium text-gray-400 mb-2">Web3 Textures</h5>
                  ...
                  <div>
                    <h5 className="text-xs font-medium text-gray-400 mb-2">Gradients</h5>
                    <div className="grid grid-cols-3 gap-2">
                      <button
                  ...
                  <div>
                    <h5 className="text-xs font-medium text-gray-400 mb-2">Paper Textures</h5>
                    <div className="grid grid-cols-3 gap-2">
                      <button
                  ...
                  <div>
                    <h5 className="text-xs font-medium text-gray-400 mb-2">Futuristic</h5>
                    <div className="grid grid-cols-3 gap-2">
                      <button
                  ...
                  <div>
                    <h5 className="text-xs font-medium text-gray-400 mb-2">Custom Color</h5>
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <div className="text-xs text-gray-400">Pick a custom background color</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {WEB3_COLORS.map((color) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-full hover:scale-110 transition-transform ${
                      currentColor === color ? "ring-2 ring-white ring-offset-2 ring-offset-gray-900" : ""
                    }`}
        ...
        <div className="flex items-center gap-3 min-w-[200px]">
          ...
          <span className="text-sm text-gray-300 min-w-[24px] text-center">{brushSize}</span>
        </div>
