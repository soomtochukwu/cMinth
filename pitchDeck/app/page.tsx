            ...
            >
              <div className="relative w-8 h-8">
                ...
                <div className="absolute inset-0">
                  <div
                    className="absolute w-1.5 h-1.5 bg-cyan-400 rounded-full top-1/4 left-1/4 animate-pulse"
                    style={{ animationDelay: "0.2s" }}
                  ></div>
                  <div
                    className="absolute w-1.5 h-1.5 bg-cyan-400 rounded-full top-1/4 right-1/4 animate-pulse"
                    style={{ animationDelay: "0.4s" }}
                  ></div>
                  <div
                    className="absolute w-1.5 h-1.5 bg-cyan-400 rounded-full bottom-1/4 left-1/4 animate-pulse"
                    style={{ animationDelay: "0.6s" }}
                  ></div>
                  <div
                    className="absolute w-1.5 h-1.5 bg-cyan-400 rounded-full bottom-1/4 right-1/4 animate-pulse"
...
function Web3Card({
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-gradient-to-r from-${glowColor}-500/5 to-purple-500/5 opacity-50`}
      />
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center text-center relative">
      ...
      <div className="space-y-8 relative z-10">
        ...
        >
          ...
          >
            <div className="relative w-24 h-24">
              ...
              <div className="absolute inset-0">
                <div
                  className="absolute w-2 h-2 bg-cyan-400 rounded-full top-1/4 left-1/4 animate-pulse shadow-lg shadow-cyan-400/50"
                  style={{ animationDelay: "0.2s" }}
                ></div>
                <div
                  className="absolute w-2 h-2 bg-cyan-400 rounded-full top-1/4 right-1/4 animate-pulse shadow-lg shadow-cyan-400/50"
                  style={{ animationDelay: "0.4s" }}
                ></div>
                <div
                  className="absolute w-2 h-2 bg-cyan-400 rounded-full bottom-1/4 left-1/4 animate-pulse shadow-lg shadow-cyan-400/50"
                  style={{ animationDelay: "0.6s" }}
                ></div>
                <div
                  className="absolute w-2 h-2 bg-cyan-400 rounded-full bottom-1/4 right-1/4 animate-pulse shadow-lg shadow-cyan-400/50"
                  style={{ animationDelay: "0.8s" }}
                ></div>
              </div>
              <div
                className="absolute -top-2 -right-2 w-4 h-4 bg-gradient-to-br from-yellow-400 to-red-500 rounded-full transform rotate-45 opacity-70"
                style={{
                  borderRadius: "50% 0",
        ...
        >
          <p className="text-lg">
            Empowering artists and musicians to mint and sell NFTs with fair
            royalties
          </p>
          <div className="flex items-center justify-center gap-6 text-sm">
            <span className="flex items-center gap-2">
              <svg className="w-4 h-4 text-cyan-400" viewBox="0 0 80 80">
                <path
                  d="M20 40 C20 25, 35 25, 40 40 C45 55, 60 55, 60 40 C60 25, 45 25, 40 40 C35 55, 20 55, 20 40 Z"
                  fill="currentColor"
                />
        ...
        >
          <Web3Card glowColor="purple">
            ...
            <CardContent className="space-y-4 text-slate-300">
              ...
              >
                A decentralized NFT platform for artists and musicians to
                monetize digital art (JPG, PNG, GIF) and music (MP3, WAV).
              </motion.p>
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                Creators mint NFTs via an ERC721 contract on Lisk L2 blockchain,
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        >
          <Web3Card glowColor="red" className="h-full">
            ...
            <CardContent className="text-slate-300">
              <p>
                Centralized platforms take up to 50% in fees, drastically
                reducing creator earnings.
              </p>
        ...
        >
          <Web3Card glowColor="orange" className="h-full">
            ...
            <CardContent className="text-slate-300">
              <p>
                Creators lack ownership and control over their content and
                revenue streams.
              </p>
              <div className="mt-4 flex items-center gap-2 text-orange-300">
                <svg className="w-4 h-4" viewBox="0 0 80 80">
                  <path
                    d="M20 40 C20 25, 35 25, 40 40 C45 55, 60 55, 60 40 C60 25, 45 25, 40 40 C35 55, 20 55, 20 40 Z"
                    fill="currentColor"
                  />
        ...
        >
          <Web3Card glowColor="yellow" className="h-full">
            ...
            <CardContent className="text-slate-300">
              <p>
                NFT platforms are complex, expensive (high gas fees), and
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-slate-300">
                  Part of the $250B creator economy (2025 est.)
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
              ...
              >
                ...
                <p className="text-slate-300">
                  Seeking authentic digital assets and direct creator support
                </p>
              </motion.div>
            </div>
          </CardContent>
          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <motion.p
                ...
                className="text-slate-300"
              >
                Create NFTs on-the-go with our built-in canvas tool - no
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="text-6xl font-bold text-green-400 mb-2 relative z-10">
                    10%
                  </div>
                  <div className="absolute inset-0 bg-green-400/20 blur-2xl rounded-full" />
                </motion.div>
                <p className="text-slate-300">
                  Platform fee on all NFT sales (primary and secondary)
                </p>
              </div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-sm text-slate-300">
                  Lisk L2 minimizes gas fees; IPFS reduces storage costs
                </p>
              </motion.div>
            </CardContent>
          </Web3Card>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-sm text-slate-400">
                  With creator onboarding and marketplace expansion
                </p>
              </motion.div>
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-slate-300">
                    Upload art/music or use 2D canvas
                  </span>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  ...
                  <span className="text-slate-300">
                    Mint NFT and sell in marketplace
                  </span>
                </motion.div>
              </div>
            </CardContent>
        ...
        {[
          ...
          >
            <Web3Card glowColor={item.color}>
              <CardHeader>
                <CardTitle
                  className={`text-${item.color}-400 text-center flex items-center justify-center gap-2`}
                >
            ...
            <div className="text-center space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                >
                  ...
                  <p className="text-slate-300">
                    Lisk L2 handles high throughput
                  </p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
        ...
        >
              ...
              <div className="space-y-4">
                ...
                >
                  <span className="text-white font-semibold flex items-center gap-2">
                    <svg className="w-4 h-4 text-green-400" viewBox="0 0 80 80">
                      <path
                        d="M20 40 C20 25, 35 25, 40 40 C45 55, 60 55, 60 40 C60 25, 45 25, 40 40 C35 55, 20 55, 20 40 Z"
                        fill="currentColor"
                      />
                ...
                >
                  ...
                  <Badge
                    variant="outline"
                    className="text-slate-400 border-slate-500/30"
                  >
                    50-80%
                  </Badge>
                </motion.div>
          ...
          >
            <Web3Card glowColor="blue">
              ...
              <CardContent className="text-slate-300">
                <p>
                  Lisk L2 reduces gas fees significantly compared to
                  Ethereum-based platforms, making NFT creation accessible to
                  all creators.
                </p>
        ...
        >
          ...
          >
            <Web3Card glowColor="pink">
              ...
              <CardContent className="text-slate-300">
                <p>
                  Tailored specifically for music and art creators, unlike
                  generic NFT marketplaces that serve all use cases.
                </p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
          ...
          <Web3Card glowColor="red">
            ...
            <CardContent className="space-y-3">
              <p className="text-slate-300 text-sm">
                Risk: Vulnerabilities in smart contract code
              </p>
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-green-200 text-sm">
                  Use OpenZeppelin standards, plan for professional audits
                </p>
              </motion.div>
            </CardContent>
          </Web3Card>
        ...
        >
          <Web3Card glowColor="orange">
            ...
            <CardContent className="space-y-3">
              <p className="text-slate-300 text-sm">
                Risk: High transaction costs deterring users
              </p>
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-green-200 text-sm">
                  Lisk L2 ensures affordable transactions
                </p>
              </motion.div>
            </CardContent>
          </Web3Card>
        ...
        >
          <Web3Card glowColor="yellow">
            ...
            <CardContent className="space-y-3">
              <p className="text-slate-300 text-sm">
                Risk: Content availability and permanence
              </p>
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-green-200 text-sm">
                  Partner with robust pinning services (e.g., Pinata)
                </p>
              </motion.div>
            </CardContent>
          </Web3Card>
        ...
        >
          <Web3Card glowColor="purple">
            ...
            <CardContent className="space-y-3">
              <p className="text-slate-300 text-sm">
                Risk: Delivering MVP in 2-week sprint
              </p>
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-green-200 text-sm">
                  Prioritize core features (minting, marketplace); defer
                  non-essentials
                </p>
              </motion.div>
            </CardContent>
            ...
            <div className="text-center space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                >
                  ...
                  <p className="text-slate-300">
                    Battle-tested libraries and audit planning
                  </p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  ...
                  <p className="text-slate-300">
                    Iterative approach with core feature focus
                  </p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  ...
                  <p className="text-slate-300">
                    Reliable partners and redundant systems
                  </p>
                </motion.div>
              </div>
            </div>
    ...
    <div className="min-h-[80vh] flex items-center justify-center relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(8)].map((_, i) => (
          ...
          >
            <svg className="w-6 h-6 text-cyan-400/30" viewBox="0 0 80 80">
              <path
                d="M20 40 C20 25, 35 25, 40 40 C45 55, 60 55, 60 40 C60 25, 45 25, 40 40 C35 55, 20 55, 20 40 Z"
                fill="currentColor"
              />
          ...
          >
            <Web3Card glowColor="green">
              <CardContent className="pt-6 text-center space-y-4">
                ...
                <p className="text-slate-300">
                  90% to creators with true ownership
                </p>
              </CardContent>
            </Web3Card>
          </motion.div>
          ...
          >
            <Web3Card glowColor="purple">
              <CardContent className="pt-6 text-center space-y-4">
                ...
                <p className="text-slate-300">
                  Lean MVP, scalable tech, passionate builders
                </p>
              </CardContent>
            </Web3Card>
          </motion.div>
        ...
        >
          <div className="relative">
            <Badge className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 text-cyan-300 border-cyan-500/30 text-lg px-6 py-3">
              <svg className="w-5 h-5 mr-2" viewBox="0 0 80 80">
                <path
                  d="M20 40 C20 25, 35 25, 40 40 C45 55, 60 55, 60 40 C60 25, 45 25, 40 40 C35 55, 20 55, 20 40 Z"
                  fill="currentColor"
                />
